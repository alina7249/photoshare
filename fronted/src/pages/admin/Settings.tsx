  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center">
        ...
        <div className="ml-4 px-3 py-1 bg-accent/20 text-accent rounded-full text-xs font-medium">
          仅超级管理员可访问
        </div>
      </div>
            ...
            >
              <div className="bg-deep rounded-xl p-6 border border-accent">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-text-muted mb-2">网站名称</label>
                    <input
                      type="text"
                      value={siteName}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-text-muted mb-2">网站描述</label>
                    <textarea
                  ...
                  <div>
                    <label className="block text-sm font-medium text-text-muted mb-2">最大上传文件大小 (MB)</label>
                    <input
                      type="number"
                      value={maxFileSize}
                  ...
                  <div className="md:col-span-2">
                    <div className="flex items-center justify-between">
                      <div>
                        <label className="block text-sm font-medium text-text-muted mb-2">维护模式</label>
                        <p className="text-xs text-accent-hover">启用后网站将进入维护状态，仅管理员可访问</p>
                      </div>
                  ...
                  <div className="md:col-span-2">
                    <div className="flex items-center justify-between">
                      <div>
                        <label className="block text-sm font-medium text-text-muted mb-2">允许用户注册</label>
                        <p className="text-xs text-accent-hover">关闭后新用户将无法注册账号</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input 
                          type="checkbox" 
          ...
          {activeTab === 'security' && (
            ...
            >
              <div className="bg-deep rounded-xl p-6 border border-accent">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-text-muted mb-2">密码复杂度要求</label>
                    <select
                  ...
                  <div className="md:col-span-2">
                    <div className="flex items-center justify-between">
                      <div>
                        <label className="block text-sm font-medium text-text-muted mb-2">双因素认证</label>
                        <p className="text-xs text-accent-hover">启用后用户登录需要验证额外的安全码</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input 
                          type="checkbox" 
              ...
              <div className="bg-deep rounded-xl p-6 border border-accent">
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-accent">
                    <thead>
                      <tr>
                        <th className="px-6 py-3 text-left text-xs font-medium text-text-muted uppercase tracking-wider">权限项</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-text-muted uppercase tracking-wider">超级管理员</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-text-muted uppercase tracking-wider">管理员</th>
                        <th className="px-6 py-3 text-left text-xs font-medium text-text-muted uppercase tracking-wider">运营人员</th>
              ...
              <div className="bg-deep rounded-xl p-6 border border-accent">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="md:col-span-2">
                    <div className="flex items-center justify-between">
                      <div>
                        <label className="block text-sm font-medium text-text-muted mb-2">启用邮件通知</label>
                        <p className="text-xs text-accent-hover">启用后系统将发送邮件通知给用户</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input 
                          type="checkbox" 
                  ...
                  <div>
                    <label className="block text-sm font-medium text-text-muted mb-2">SMTP服务器地址</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-text-muted mb-2">SMTP服务器端口</label>
                    <input
                      type="number"
                      defaultValue="587"
                      className="w-full px-4 py-2 bg-card border border-accent text-text-primary rounded-lg focus:outline-none focus:ring-2 focus:ring-accent transition-all"
            ...
            >
              <div className="bg-deep rounded-xl p-6 border border-accent">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="md:col-span-2">
                    <h3 className="font-medium text-text-primary mb-3">备份历史</h3>
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-accent">
                        <thead>
                          <tr>
                            <th className="px-6 py-3 text-left text-xs font-medium text-text-muted uppercase tracking-wider">备份名称</th>
                            <th className="px-6 py-3 text-left text-xs font-medium text-text-muted uppercase tracking-wider">类型</th>
                            <th className="px-6 py-3 text-left text-xs font-medium text-text-muted uppercase tracking-wider">大小</th>
                        ...
                        <tbody className="divide-y divide-accent">
                          <tr>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-text-primary">完整备份_20231025</td>
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span className="px-2 py-1 bg-accent/20 text-accent text-xs rounded-full">完整备份</span>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-text-muted">1.2 GB</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-text-muted">2023-10-25 02:00:00</td>
                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm">
                          ...
                          <tr>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-text-primary">数据库备份_20231020</td>
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span className="px-2 py-1 bg-accent-hover/20 text-accent-hover text-xs rounded-full">数据库备份</span>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-text-muted">256 MB</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-text-muted">2023-10-20 02:00:00</td>
                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm">
                              <div className="flex justify-end space-x-2">
                                <button className="text-accent hover:text-accent-hover transition-colors">
                                  <i className="fa-solid fa-download"></i>
                  ...
                  <div className="md:col-span-2">
                    <div className="p-4 bg-card rounded-lg border border-accent">
                      ...
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          <label className="block text-sm font-medium text-text-muted mb-1">启用自动备份</label>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input 
                            type="checkbox" 
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          <label className="block text-sm font-medium text-text-muted mb-2">保留备份数量</label>
                          <input
                            type="number"
                            defaultValue="7"
