...
const photographyPosts = [{
    ...
    image: buildCozeImageUrl('film photography portrait natural light soft colors', 'c33fc387d9611cfbf5948eab73b3426b', 'portrait_4_3'),
    author: {
        id: "2",
        name: "胶片摄影师安娜",
    ...
    image: buildCozeImageUrl('moody portrait low key dramatic lighting', '667d5b0612922acbe1a4e0355faeb800', 'landscape_4_3'),
    author: {
        id: "3",
        name: "情绪摄影师李明",
    ...
    image: buildCozeImageUrl('minimalist still life composition natural light', 'd50543b56e3575f63623ea5055f2f854', 'square_hd'),
    author: {
        id: "4",
        name: "静物摄影师王静",
        avatar: buildCozeImageUrl('still life photographer female detail-oriented', '3bfd67c585c96ccf90c0560aadfc6c75', 'square')
    },
    likes: 276,
    comments: 32,
    collections: 22,
    ...
    image: buildCozeImageUrl('urban geometry city architecture minimalist composition', 'b5c56f91ceaddbb80362822c8664e0ae', 'landscape_16_9'),
    author: {
        id: "5",
        name: "手机摄影师张强",
        avatar: buildCozeImageUrl('mobile photographer male urban explorer', '1eff3d26acd6475fd9c84ba0ee8e5d74', 'square')
    },
    likes: 321,
    comments: 41,
    collections: 25,
    ...
    image: buildCozeImageUrl('black and white street photography documentary moment', 'd29476f80a3d538bddc7d6b20fcd017d', 'landscape_16_9'),
    author: {
        id: "6",
        name: "纪实摄影师陈默",
        avatar: buildCozeImageUrl('documentary photographer male street', '788a26eea5ce0ca5b0473146963afcf0', 'square')
    },
    likes: 398,
    comments: 52,
    collections: 33,
...
const featuredPhotographers = [{
    id: "101",
    name: "黑白影像达人",
    avatar: buildCozeImageUrl('black and white photographer male serious', '7651d7d16421ab76c2b59b1bd71a39c2', 'square'),
    followers: 12543,
    posts: 324,
    level: "新锐艺术家"
}, {
    id: "102",
    name: "胶片艺术师",
    avatar: buildCozeImageUrl('film photographer female vintage', '1742134c6641907308d9b1410d65842c', 'square'),
    followers: 8765,
    posts: 213,
    level: "资深摄影师"
}, {
    id: "103",
    name: "建筑几何控",
    avatar: buildCozeImageUrl('architecture photographer male creative', '17c8985a6812f53b55a5f015db719ac3', 'square'),
    followers: 6543,
    posts: 187,
    level: "创意摄影师"
}];
...
const inspirationItems = [{
    ...
    image: buildCozeImageUrl('black and white photography tutorial light shadow', '581ada31389ae6719d75794988b72a4c', 'portrait_4_3')
}, {
    id: "2",
    title: "胶片摄影的复兴与现代应用",
    author: "安娜",
    description: "探讨胶片摄影在数字时代的独特魅力和应用场景，以及如何将传统技术融入现代创作...",
    image: buildCozeImageUrl('film camera vintage photography process', 'e4d693788f49256f00febe15b1f68df2', 'portrait_4_3')
}, {
    id: "3",
    title: "极简主义摄影的构图法则",
    author: "李明",
    description: "解析极简主义摄影的核心构图原则，帮助你创造简洁而有力的视觉表达...",
    image: buildCozeImageUrl('minimalist photography composition rules', 'fd587b41706f60a738a2464cc11304ac', 'portrait_4_3')
}, {
    id: "4",
    title: "暗房技术与现代数字暗房",
    author: "张强",
    description: "比较传统暗房技术与现代数字暗房的异同，以及如何在后期制作中保留胶片质感...",
    image: buildCozeImageUrl('darkroom photography digital workflow', 'c372da4647ca0d3c6ef6803314856aec', 'portrait_4_3')
}];
        ...
        <div className={`container mx-auto px-4 py-8 ${getPageBgClass(theme)} star-texture min-h-screen`}>
            ...
            <div className="bg-card border border-accent rounded-xl p-6 shadow-sm mb-12">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
                    <div className="flex items-center mb-4 md:mb-0">
                        <div className="w-16 h-16 rounded-full bg-accent flex items-center justify-center mr-4">
                            <i className="fa-solid fa-cloud-sun text-2xl text-text-primary"></i>
                        </div>
                        <div>
                            <h3 className="text-xl font-bold text-text-primary">北京市 - 今天</h3>
                            <p className="text-sm text-text-muted">2025年11月17日 17:41</p>
                        </div>
                    </div>
                    <div className="flex items-center">
                        <span className="text-4xl font-bold text-text-primary mr-2">15°C</span>
                        <div className="flex items-center">
                            <i className="fa-solid fa-temperature-low text-accent mr-1"></i>
                            <span className="text-text-muted">10°C</span>
                            <span className="mx-1 text-accent">/</span>
                            <i className="fa-solid fa-temperature-high text-accent mr-1"></i>
                            <span className="text-text-muted">18°C</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-deep rounded-lg p-4">
                    ...
                    <p className="text-sm text-text-muted mb-4">今日天气晴朗，微风，非常适合户外摄影。下午光线柔和，是拍摄人像和风光的黄金时段。</p>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div className="p-3 rounded-lg text-center bg-accent/20 border border-accent">
                            <p className="text-xs text-text-muted mb-1">风光摄影</p>
                        ...
                        <div className="p-3 rounded-lg text-center bg-accent/20 border border-accent">
                            <p className="text-xs text-text-muted mb-1">人像摄影</p>
                            <div className="flex justify-center">
                                {[...Array(5)].map((_, i) => <i
                                    key={i}
                        ...
                        <div className="p-3 rounded-lg text-center bg-accent/20 border border-accent">
                            <p className="text-xs text-text-muted mb-1">街拍摄影</p>
                            <div className="flex justify-center">
                                {[...Array(5)].map((_, i) => <i
                                    key={i}
                                    className={`fa-solid fa-star text-sm ${i < 4 ? "text-accent" : "text-deep"}`}></i>)}
                        ...
                        <div className="p-3 rounded-lg text-center bg-accent/20 border border-accent">
                            <p className="text-xs text-text-muted mb-1">夜景摄影</p>
                            <div className="flex justify-center">
                                {[...Array(5)].map((_, i) => <i
                                    key={i}
                ...
                <div className="mt-4">
                    <h4 className="text-base font-medium text-text-primary mb-3">未来天气预报</h4>
                    <div className="flex space-x-3 overflow-x-auto pb-2 scrollbar-hide">
                        {[{
                            ...
                            <p className="text-xs text-text-muted mb-1">{day.weather}</p>
                            <p className="text-xs text-text-primary">{day.temp}</p>
                        </div>)}
                    </div>
                </div>
            </div>
            ...
            {/* 灵感专栏 */}
            <div className="mb-12">
                <h2 className="text-2xl font-bold text-text-primary mb-6">灵感专栏</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-8">
                            ...
                            {featuredPhotographers.map(
                                photographer => <div key={photographer.id} className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <p className="font-medium text-text-primary">{photographer.name}</p>
                                            <p className="text-xs text-accent">{photographer.level}</p>
                    ...
                    <div className="bg-card border border-accent rounded-lg p-6">
                        ...
                        <img
                            src={buildCozeImageUrl('black and white photography exhibition minimalist', '2604dd032070909ae9c1f7445ad24156', 'landscape_4_3')}
                            alt="黑白影像专题"
